...
APPS = anaOptical anaMap anaBACoN anaMapBACoN anaRadio readNtuple binHistogram mapMerger
...
#INCLUDEFLAGS += -I/home/nmcfadden/nmcfadden/RooT/temp
INCLUDEFLAGS += -I./temp
